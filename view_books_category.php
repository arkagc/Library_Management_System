...
<head>
  ...
  <title>LMS | View Books Category</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Books Category</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">View Books Category</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <?php echo strtoUpper($fetch['books_category_name']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Books Category Status';?></td>
                                        <td> <?php if($fetch['books_category_status']=='Y'){ ?><span class="badge badge-success">Active</span><?php }else{ ?><span class="badge badge-danger">Inactive</span><?php }?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
