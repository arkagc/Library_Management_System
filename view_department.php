...
<head>
  ...
  <title>LMS | View Department</title>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <?php echo strtoUpper($fetch['dept_name']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Department Short Code';?></td>
                                        <td> <?php echo strtoUpper($fetch['dept_code']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Department Status';?></td>
                                        <td> <?php if($fetch['dept_status']=='Y'){ ?><span class="badge badge-success">Active</span><?php }else{ ?><span class="badge badge-danger">Inactive</span><?php }?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
