...
if(isset($_GET["dept_yr_id"])){
    ...
    //fetch from `department` table using `department_year` table
...
<head>
  ...
  <title>LMS | View Department Year</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Department Year</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">View Department Year</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <?php echo strtoUpper($fetch_dept['dept_name']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Department Short Code';?></td>
                                        <td> <?php echo strtoUpper($fetch_dept['dept_code']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Department Year';?></td>
                                        <td> <?php echo strtoUpper($fetch['dept_yr_name']);?></td>
                                    </tr>
                                    <tr>
                                        <td> <?php echo 'Department Year Status';?></td>
                                        <td> <?php if($fetch['dept_yr_status']=='Y'){ ?><span class="badge badge-success">Active</span><?php }else{ ?><span class="badge badge-danger">Inactive</span><?php }?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
