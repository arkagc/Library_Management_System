...
if(isset($_GET["books_issue_id"])){
    ...
    //fetch from `books` table using `books_issue` table
    $sql_books  = mysqli_query($con,"SELECT * FROM `books` WHERE books_id='".$fetch['books_id']."'");
    ...
    //fetch from `users` table using `books_issue` table
...
<head>
  ...
  <title>LMS | View Books Issue</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              ?>
              <li class="breadcrumb-item active">View Books Issue</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">View Books Issue</h3>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo strtoUpper($fetch_books['books_author_name']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Books Publisher';?></td>
                                            <td> <?php echo strtoUpper($fetch_books['books_publisher']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Books Edition';?></td>
                                            <td> <?php echo strtoUpper($fetch_books['books_edition']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Books Price';?></td>
                                            <td> <?php echo strtoUpper($fetch_books['books_price']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Books Total Pages';?></td>
                                            <td> <?php echo strtoUpper($fetch_books['books_total_pages']);?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td> <?php echo 'No of Books Issue';?></td>
                                            <td> <?php echo strtoUpper($fetch['books_issue_no_of_books']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Issue Date';?></td>
                                            <td> <?php echo strtoUpper($fetch['books_issue_date']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Return Date';?></td>
                                            <td> <?php echo strtoUpper($fetch['books_issue_return_date']);?></td>
                                        </tr>
                                        <tr>
                                            <td> <?php echo 'Books Issue Status';?></td>
                                            <td> <?php if($fetch['books_issue_status']=='P'){ ?><span class="badge badge-warning">Pending</span><?php }elseif($fetch['books_issue_status']=='NI'){ ?><span class="badge badge-danger">Rejected</span><?php }else{?><span class="badge badge-success">Issue</span><?php }?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
